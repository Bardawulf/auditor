...
export default {
    ...
    methods: {
        ...
        async handleLogin() {
            ...
            // ODKOMENTOWAĆ TO I PODMIENIĆ ZAKOMENTOWANE RZECZY

            /*
            post(
                this,
                'BACKEND_ENDPOINT', // ZAMIENIĆ Z NASZYM BACENDOWYM ENDPOINTEM
                data,
                async response => {
    ...
    */
            ...
            ////////////////////////////////////////////////////////////////////////////
            // Po podmiance endpointu w requescie wyżej, można to wywalić, ale zostawiam do testowania
